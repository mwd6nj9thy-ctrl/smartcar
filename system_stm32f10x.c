...
#elif defined SYSCLK_FREQ_24MHz
/**
  * @brief  Sets System clock frequency to 24 MHz and configure HCLK, PCLK2
  *         and PCLK1 prescalers.
  * @note   This function should be called only once the HSE is enabled.
  * @param  None
  * @retval None
...
#elif defined SYSCLK_FREQ_36MHz
/**
  * @brief  Sets System clock frequency to 36 MHz and configure HCLK, PCLK2
  *         and PCLK1 prescalers.
  * @note   This function should be called only once the HSE is enabled.
  * @param  None
  * @retval None
...
static void SetSysClockTo36(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /*!< PLL configuration: PLLCLK = HSE/1 * 4.5 = 36 MHz */
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL4_5);
...
#elif defined SYSCLK_FREQ_48MHz
/**
  * @brief  Sets System clock frequency to 48 MHz and configure HCLK, PCLK2
  *         and PCLK1 prescalers.
  * @note   This function should be called only once the HSE is enabled.
  * @param  None
  * @retval None
...
static void SetSysClockTo48(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /*!< PLL configuration: PLLCLK = HSE/1 * 6 = 48 MHz */
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
...
#elif defined SYSCLK_FREQ_56MHz
/**
  * @brief  Sets System clock frequency to 56 MHz and configure HCLK, PCLK2
  *         and PCLK1 prescalers.
  * @note   This function should be called only once the HSE is enabled.
  * @param  None
  * @retval None
...
static void SetSysClockTo56(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /*!< PLL configuration: PLLCLK = HSE/1 * 7 = 56 MHz */
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
